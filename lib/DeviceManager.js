...
var { DualButtonWrapper } = require('./deviceWrapper/DualButtonWrapper.js');
var { NFCWrapper } = require('./deviceWrapper/NFCWrapper.js');
var { LinearPotiWrapper } = require('./deviceWrapper/LinearPotiWrapper.js');
var { MotorizedPotiWrapper } = require('./deviceWrapper/MotorizedPotiWrapper.js');
var { OLEDDisplayWrapper } = require('./deviceWrapper/OLEDDisplayWrapper.js');
var { PiezoSpeakerWrapper } = require('./deviceWrapper/PiezoSpeakerWrapper.js');
  ...
  _registerDevice(uid, connectedUid, position, hardwareVersion, firmwareVersion,
    ...
    switch (deviceIdentifier) {
      ...
      case 27:
        ...
        break;
      case 213:
        deviceName = "Linear Poti Bricklet";
        device = new tinkerforge.BrickletLinearPoti(uid, this.ipcon);
        deviceWrapper = new LinearPotiWrapper(device, uid, deviceIdentifier);
        break;
      case 216:
      ...
      case 230:
        ...
        deviceWrapper = new DualButtonWrapper(device, uid, deviceIdentifier);
        break;
      case 239:
      ...
      case 242:
        ...
        deviceWrapper = new PiezoSpeakerWrapper(device, uid, deviceIdentifier);
        break;
      case 243:
      ...
      case 263:
        ...
        deviceWrapper = new OLEDDisplayWrapper(device, uid, deviceIdentifier);
        break;
      case 265:
        ...
        break;
      case 267:
        deviceName = "Motorized Linear Poti Bricklet";
        device = new tinkerforge.BrickletMotorizedLinearPoti(uid, this.ipcon);
        deviceWrapper = new MotorizedPotiWrapper(device, uid, deviceIdentifier);
        break;
      case 271:
      ...
      case 286:
        ...
        deviceWrapper = new NFCWrapper(device, uid, deviceIdentifier);
        break;
      default:
        deviceName = "Unknown";
        break;
